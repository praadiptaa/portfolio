  ...
  return (
    <AnimatedContainer>
      <main className="min-h-screen flex flex-col items-center justify-center text-center">
        ...
        <p className="text-lg text-gray-400 mb-6">{t.contact.desc}<a href={`mailto:${(t.contact as any).email}`} className="underline text-white">{(t.contact as any).email}</a> {" "} {"or fill the form below."}</p>
